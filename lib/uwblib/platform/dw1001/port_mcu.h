...
#define sys_printf            host_com_print_log
...
#define dw_task_setup(...)
#define uwb_cb_task_setup(...)
...
uint64_t convertMs2Ticks(uint32_t ms);
...
//   SERIAL
//******************************************************************************
typedef void (*data_ready_callback_t)(void);
